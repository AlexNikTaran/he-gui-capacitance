...
% Hints: get(hObject,'String') returns contents of battery_id as text
%        str2double(get(hObject,'String')) returns contents of battery_id as a double
...
% Hints: get(hObject,'String') returns contents of battery_capacity as text
%        str2double(get(hObject,'String')) returns contents of battery_capacity as a double
